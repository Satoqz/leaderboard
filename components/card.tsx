      ...
      return (
        <Fragment>
          <div className={styles.userLeft}>
            ...
            <img className={styles.userIcon} src={this.state.url} onError={() => this.setImage()} />
            <div className={styles.userName}>{this.user.name}</div>
          </div>
          <div className={styles.userLeft}>
            <div className={styles.statBlock}>
              <div className={styles.statName}>XP</div>
              <div className={styles.statValue}>{this.user.level_xp} / {this.user.levelup_xp}</div>
            </div>
            <div className={styles.statBlock}>
